...
pageTagDB = M.fromList [
  ...
  , ("/Archiving-URLs", ["linkrot/archiving"])
  ...
  , ("/Greenland", ["economics"])
  , ("/Hafu", ["anime"])
  , ("/haskell/Archiving-GitHub", ["cs/haskell"])
  , ("/haskell/Run-Length-Encoding", ["cs/haskell"])
  , ("/haskell/Summer-of-Code", ["cs/haskell"])
  , ("/haskell/Wikipedia-Archive-Bot", ["cs/haskell"])
  , ("/haskell/Wikipedia-RSS-Archive-Bot", ["cs/haskell"])
  ...
  , ("/presocratic-path-to-atomism", ["philosophy/ontology"])
  , ("/Red", ["design"])
  , ("/Replication", ["statistics/bias"])
  , ("/Resilient-Haskell-Software", ["cs/haskell"])
  ...
  , ("/Self-decrypting-files", ["cs/cryptography"])
  , ("/sicp/Chapter-1-1", ["cs/scheme"])
  , ("/sicp/Chapter-1-2", ["cs/scheme"])
  , ("/sicp/Chapter-1-3", ["cs/scheme"])
  , ("/sicp/Introduction", ["cs/scheme"])
  , ("/Sidenotes", ["design"])
  , ("/Silk-Road", ["silk-road"])
  , ("/Simulation-inferences", ["cs"])
  , ("/SMPY", ["iq/smpy"])
  , ("/Sort", ["cs"])
  , ("/sources-of-religious-experience", ["philosophy/religion"])
  ...
  , ("/The-Narrowing-Circle", ["philosophy/ethics"])
