...
filterAnchors   t = T.length t > anchorLengthMaximum ||
                    ...
                    "/docs/" `T.isPrefixOf` t && "/index" `T.isSuffixOf` t ||
                    t =~ regex ||
                    anyInfixT t ["$","%","[","]"] ||
                    anyPrefixT t ["(","."] ||
                    "&"==t ||
