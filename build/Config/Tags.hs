...
tagsShort2LongRewrites =
   ...
   , ("qeueing", "queueing"), ("qeuing", "queueing"), ("queing", "queueing"), ("queing-theory", "queueing"), ("queing_theory", "queueing"), ("queingtheory", "queueing")
   , ("queueing-theory", "queueing"), ("queueing_theory", "queueing"), ("queueingtheory", "queueing"), ("queue", "queueing"), ("queues", "queueing"), ("queue-theory", "queueing"), ("queue_theory", "queueing"), ("queuetheory", "queueing"), ("queuingtheory", "queueing"), ("queuing-theory", "queueing"), ("queuing_theory", "queueing"), ("quing", "queueing"), ("queuing", "queueing")   -- there are just way too many ways to spell 'queue'...
...
tagsLong2Short = reverse [ -- priority: first one wins. so sub-directories should come before their directories if they are going to override the prefix.
  ...
  , ("fiction/poetry/pindar", "Pindaric poetry")
  ...
  , ("ai/nn/transformer/gpt/claude/mythos",      "Claude Mythos AI")
  ...
  , ("ai/nn/transformer/gpt/5-5",                "GPT-5.5")
