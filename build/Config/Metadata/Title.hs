...
badStrings = setLike ["", " ", "Quanta Magazine", "OSF", "CAIDA Resource Catalog", "Blogger", "Log in", "Stuff", "common.redirect_permanent.title", "Search", "search"
     ...
     , "Redirecting", "x.com", "Welcome to the Orion's Arm Universe Project", "Web Page Under Construction"
     , "Organization not found", "Page not found - Rybka Forum", "APA Dictionary of Psychology"
     , "0xPARC", "graydon2", "Vimeo / CAPTCHA Challenge", "Bulletin of the Atomic Scientists"
     , "ORCID", "This page could not be found", "Are you a robot?", "Dario Amodei", "Nabeel S. Qureshi"
     , "ScienceDirect", "smoothbrains.net", "home", "Welcome", "welcome", "index.utf8"
     , "Getting Stronger", "University College London", "lamag.com", "nyuu dot page", "Perma"
     ...
     , "IMBEI", "naml.us", "Redirecting The Scholar's Stage", "Research units", "Reddit—The heart of the internet"
     , "Reddit - The heart of the internet", "Bloomberg - Are you a robot?", "Aizk’s Site", "Aizk's Site"
     , "Personal profile - UPJS Kosice", "Personal profile—UPJS Kosice", "Edward Tufte: New ET Writings, Artworks &amp; News"
     , "fi-le.net", "Personal Page", "Fantasy and Science Fiction", "Sam Patterson", "Subscribe to read"
     , "Internet Sacred Text Archive", "Ricki Heicklen", "Language Log", "Construction Physics", "Stan Winston School of Character Arts"
     ...
     , "archiveofourown.org", "Reddit - Please wait for verification", "Newsletter", "429 Too Many Requests", "Health", "ISRCTN", "Epic Research", "Internal Server Error", "Surya Narreddi", "Plain Form", "Security Verification"]
...
stringDelete = setLike [" - The Public Domain Review"
            ...
            , "A Knight at the Opera: ", "Res Obscura: ", " • European Platform of Women Scientists"
            , " - HoloWiki - A Holography FAQ", " - by Brian Potter", "—Free Online Library", "Ebony: "
            , " - A Collection of Unmitigated Pedantry", " - Dominic Cummings substack", "Code rant: "
            , " - Economics from the Top Down", " - Link error", " - Jenneral HQ", " - Reactor"
            , "PStricks : applications ", "Moneyness: ", " - Thingiverse", "- Review - Anime News Network"
            , " by Unseen Histories - Unseen Histories", " | Blog", " - Wikimedia Commons"
            ...
            , " - Deviant/Abstraction", " : Free Download, Borrow, and Streaming : Internet Archive", " - TalkChess.com", " - Works in Progress", "SL4: ", " - Engineering and Technology History Wiki"
            , " - Dominic Cummings's Blog", " - Ethan Zuckerman", "The Ants Of God Are Queer Fish: "
            ...
            , " - Big Sand Woodworking", "Emigre: ", "David T. Wilbanks: ", " - Asimov Press"
            , " :: SSRN", " - Adam LeBlanc", "Gesta Septentrionalis: ", " - Internal exile", " - Ben"
            , " | The Calvin and Hobbes Wiki", " at Interrobang Type Co", " - For Better", "<br />", "<br>", "<br/>"
            ...
            , " - Ars Technica", "XBOW - ", " :: Himanshu Anand :: Threat Notes", "Literary Hub - ", "Dinosaur Comics - ", " - awesome fun times!", " - David Oks", " - by Nathan Lambert", " - Biblioklept", "Paul Buchheit: ", " - by Andy Hall", " - by Daniel Frank", "SciFi Japan - ", " - The Linchpin", " - The Trail of Bits Blog"]
