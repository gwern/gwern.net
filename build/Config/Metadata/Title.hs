...
stringDelete = setLike [" - The Public Domain Review"
            ...
            , " - Ars Technica", "XBOW - ", " :: Himanshu Anand :: Threat Notes", "Literary Hub - ", "Dinosaur Comics - ", " - awesome fun times!", " - David Oks", " - by Nathan Lambert", " - Biblioklept", "Paul Buchheit: ", " - by Andy Hall", " - by Daniel Frank", "SciFi Japan - "]
