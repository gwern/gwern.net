...
stringDelete = [" - The Public Domain Review"
            ...
            , "- jreyesr’s blog", "Old Vintage Computing Research: ", "Flight From Perfection - ", "A Knight at the Opera: ", "Res Obscura: ", " • European Platform of Women Scientists", " - HoloWiki - A Holography FAQ", " - by Brian Potter", "—Free Online Library", "Ebony: ", " - A Collection of Unmitigated Pedantry", " - Dominic Cummings substack", "Code rant: ", " - Economics from the Top Down", " - Link error", " - Jenneral HQ", " - Reactor", "PStricks : applications ", "Moneyness: ", " - Thingiverse", "- Review - Anime News Network", " by Unseen Histories - Unseen Histories", " | Blog", " - Wikimedia Commons", " | by Merzmensch | Merzazine"]
