...
badStrings = ["", " ", "Quanta Magazine", "OSF", "CAIDA Resource Catalog", "Blogger", "Log in", "Stuff", "common.redirect_permanent.title", "Search", "search"
     ...
     , "SAS Proceedings and more - 404", "Inception Labs", "Access Denied", "News details", "UK"]
...
stringDelete = [" - The Public Domain Review"
            ...
            , " - Deviant/Abstraction", " : Free Download, Borrow, and Streaming : Internet Archive", " - TalkChess.com"]
