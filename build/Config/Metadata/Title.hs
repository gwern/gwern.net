...
badStrings = ["", " ", "Quanta Magazine", "OSF", "CAIDA Resource Catalog", "Blogger", "Log in", "Stuff", "common.redirect_permanent.title", "Search", "search"
     ...
     , "Colin Woodbury", "Machine Learning", "Discovery", "Client Challenge", "X Cancelled", "Minusx", "Mariano Gappa’s Blog", "HAMIDI USA", "Shtetl-Optimized"]
...
stringDelete = [" - The Public Domain Review"
            ...
            , " : Institute for Policy Research - Northwestern University", "Snarkmarket: ", " - Google Developers Blog", " - Dmitry Brant", "Geoff Greer’s site: ", "Wes McKinney - ", " - an article by Chris Morgan", "First Known When Lost: ", " - by Bryan Caplan"]
