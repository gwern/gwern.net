...
badStrings = setLike ["", " ", "Quanta Magazine", "OSF", "CAIDA Resource Catalog", "Blogger", "Log in", "Stuff", "common.redirect_permanent.title", "Search", "search"
     ...
     , "archiveofourown.org", "Reddit - Please wait for verification", "Newsletter", "429 Too Many Requests"]
...
stringDelete = setLike [" - The Public Domain Review"
            ...
            , "God Plays Dice: ", " - by Benjamin Grayzel - Benjamin’s Substack", " - by Beau Watson", " - To Whom It May Concern", " - Ars Technica"]
