...
stringDelete = [" - The Public Domain Review"
            ...
            , " - Big Sand Woodworking", "Emigre: ", "David T. Wilbanks: ", " - Asimov Press", " :: SSRN", " - Adam LeBlanc", "Gesta Septentrionalis: ", " - Internal exile", " - Ben", " | The Calvin and Hobbes Wiki", " at Interrobang Type Co", " - For Better", "<br />", "<br>", "<br/>", " - by Benjamin Breen"]
