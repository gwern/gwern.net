...
badStrings = ["", " ", "Quanta Magazine", "OSF", "CAIDA Resource Catalog", "Blogger", "Log in", "Stuff", "common.redirect_permanent.title", "Search", "search"
     ...
     , "SAS Proceedings and more - 404", "Inception Labs", "Access Denied", "News details", "UK", "Heart of the internet", "IMBEI", "naml.us", "Redirecting The Scholar's Stage", "Research units", "Reddit—The heart of the internet", "Reddit - The heart of the internet", "Bloomberg - Are you a robot?", "Aizk’s Site", "Aizk's Site", "Personal profile - UPJS Kosice", "Personal profile—UPJS Kosice", "Edward Tufte: New ET Writings, Artworks &amp; News", "fi-le.net", "Personal Page", "Fantasy and Science Fiction", "Sam Patterson", "Subscribe to read", "Internet Sacred Text Archive", "Ricki Heicklen", "Language Log", "Construction Physics", "Stan Winston School of Character Arts", "No Moods, Ads or Cutesy Fucking Icons", "Bloomberg", "PROSPERO", "archive.is", "Notion", "Yahoo", "inc.com", "Colin Woodbury"]
...
stringDelete = [" - The Public Domain Review"
            ...
            , " - Big Sand Woodworking", "Emigre: ", "David T. Wilbanks: ", " - Asimov Press", " :: SSRN", " - Adam LeBlanc", "Gesta Septentrionalis: ", " - Internal exile", " - Ben", " | The Calvin and Hobbes Wiki", " at Interrobang Type Co", " - For Better", "<br />", "<br>", "<br/>", " - by Benjamin Breen", " - You Are a Story with Will Storr", " - Isegoria", " - TASVideos", " - by Colin Gorrie", " - SimEdw’s Blog", "nfdn: ", " - by Erik Hoel", " - John Luttig", " @ osmarks' website", " at MROB", " - Clear Language, Clear Mind", " : Institute for Policy Research - Northwestern University"]
