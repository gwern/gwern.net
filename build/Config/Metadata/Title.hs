...
stringDelete = [" - The Public Domain Review"
            ...
            , "- jreyesr’s blog", "Old Vintage Computing Research: ", "Flight From Perfection - ", "A Knight at the Opera: "]
