...
stringDelete = [" - The Public Domain Review"
            ...
            , " - Big Sand Woodworking", "Emigre: ", "David T. Wilbanks: ", " - Asimov Press", " :: SSRN", " - Adam LeBlanc", "Gesta Septentrionalis: "]
