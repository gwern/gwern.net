...
badStrings = ["", " ", "Quanta Magazine", "OSF", "CAIDA Resource Catalog", "Blogger", "Log in", "Stuff", "common.redirect_permanent.title", "Search", "search"
     ...
     , "Reddit - Dive into anything", "why why why why why why why", "Exclusive", "Randomly updated", "Redirecting", "x.com", "Welcome to the Orion's Arm Universe Project", "Web Page Under Construction", "Organization not found", "Page not found - Rybka Forum", "APA Dictionary of Psychology", "0xPARC", "graydon2", "Vimeo / CAPTCHA Challenge", "Bulletin of the Atomic Scientists", "ORCID", "This page could not be found", "Are you a robot?", "Dario Amodei", "Nabeel S. Qureshi", "ScienceDirect", "smoothbrains.net", "home", "Welcome", "welcome", "index.utf8", "Getting Stronger", "University College London", "lamag.com", "nyuu dot page", "Perma", "Justin Pombrio", "ōtoro.net", "Research Scientist", "Vanderbilt University School of Medicine", "Olup Stories", "Human Verification", "Oceans Yet to Burn", "Wiremodal", "OUH - OUH group members", "Sergey’s Blog", "Sensor Fusion: High Speed Robots", "SAS Proceedings and more - 404"]
...
stringDelete = [" - The Public Domain Review"
            ...
            , "- jreyesr’s blog", "Old Vintage Computing Research: ", "Flight From Perfection - ", "A Knight at the Opera: ", "Res Obscura: ", " • European Platform of Women Scientists", " - HoloWiki - A Holography FAQ", " - by Brian Potter", "—Free Online Library", "Ebony: ", " - A Collection of Unmitigated Pedantry", " - Dominic Cummings substack", "Code rant: ", " - Economics from the Top Down", " - Link error", " - Jenneral HQ", " - Reactor", "PStricks : applications ", "Moneyness: ", " - Thingiverse", "- Review - Anime News Network", " by Unseen Histories - Unseen Histories", " | Blog", " - Wikimedia Commons", " | by Merzmensch | Merzazine", " - The Law and Policy Blog", " - Daniel Wirtz", "Machinamenta: ", "Radiator Blog: ", "  Journal of Heredity", " - media.ccc.de", " - UEFConnect", " | Technology", " - Flashback Forum", " - Chiraag Gohel"]
