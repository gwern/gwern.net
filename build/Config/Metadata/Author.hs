...
canonicalsWithInitials = setLike
 ["Ingrid Sigfrid Melle", "Ken K. Ong", "Lenore J. Launer", "Olli T. Raitakari"
  ...
  , "M. Saiful Bari", "Robert A. Freitas", "Roland G. Fryer", "Leslie Stephen Coles", "Mathew John Wedel", "Ralph S. Baric"]
...
authorLinkDB = M.fromList $
  zip authorWpLinkDB (map toWikipediaEnURL authorWpLinkDB) ++ -- we put the WP link first for easier reading/editing, but all WP entries are overridden by by an entry below:
   setLike [ ("George Washington#SS", "https://en.wikipedia.org/wiki/SS_George_Washington")
    ...
    , ("Paul Darwin Foote", "/doc/science/physics/1979-astin.pdf")
    ...
    , ("Ronny Myhre", "https://scholar.google.com/citations?user=ARSOHjsAAAAJ")
    ...
    , ("Matthew Botvinick", "https://scholar.google.com/citations?user=eM916YMAAAAJ")
...
authorWpLinkDB = setLike
    ...
    ,"David Whitney", "David Wisniewski", "David Xiao", "David de la Croix"
    ...
    , "D. Graham Burnett", "Edward Johnston", "Jacob Glanville", "F. Wesley Schneider", "Aaron Swartz", "Edwin Leuven"
    , "Pliny the Elder", "Mark Wallinger", "Dave Winer", "Don Hopkins", "Charles Baudelaire", "James E. Cutting"
    , "American Veterinary Medical Association", "John Rosengrant", "Christopher Smart", "Rick Gibson", "Christian Bök"
    , "David Hestenes", "Yu-Ao_Chen", "Frank Wilczek", "Pan Jianwei", "Gillian Cookson", "Thomas Hinde", "Jeff Gore"
    , "Ann O'Leary", "Silvana Konermann", "Liang Wenfeng", "Fernanda Viégas", "Wyndham Lewis", "Jef Raskin", "Bruce Sterling"
    , "Pauline Grosjean", "Dilek Hakkani-Tür", "Rick Rubin", "Winthrop Kellogg", "Edwin H. Land", "Daphna Joel", "Yael Niv"
    , "Adam Kilgarriff", "A. Michael Noll", "Richard R. Nelson", "Andy Greenberg", "Kathy Schick", "Nicholas Toth", "Robert Gallo"
    , "Erving Goffman", "Garrett Birkhoff", "Daniel M. Russell", "Andrea Califano", "Abby F. Dernburg", "Emily B. Fox"
    , "Patrick D. Hsu", "Thomas Kalil", "Shana O. Kelley", "Anna Kreshuk", "Tim Mitchison", "Stephen R. Quake", "Leila Takayama"
    ...
    , "Bali Pulendran", "Yascha Mounk", "Peter B. Andrews"]
