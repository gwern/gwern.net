...
cleanAuthorsFixedRewrites = [(". . ", ". "), ("?",""), (",,", ","), (", ,", ", "), (" MA,", ","), (", MA,", ","), (" MS,", ","), (" ScD MPH", ""), (" ScD,", ",")
                            , ("Dr. ", "") , ("Dr ", ""), (" Eh.D.", ""), (" PhD", ""), (" Ph.D.", ""), (" MRCGP", ""), (" OTR/L", ""), (" OTS", "")
...
filterMetaBadSubstrings = ["ABBYY", "Adobe", "InDesign", "Arbortext", "Unicode", "Total Publishing", "pdftk", "aBBYY"
                          ...
                          , "ARTICLIZER", "c:/ncn", "1QS4P", "2-0crc", "Trove", "REV_ISS", "WEB_CDEV", "HelenMartin", "DALiM", "HP PDF", "PDF Formatter", "Xerox D125", "Copier-Printer", "PubTeX", "C:My Documents", ".wp", "Nova India", "/var/www", "oup_cercor", "oup_humrep", "Print Publisher", "11.1.4012/W", "PDFium", "Internet Archive (Scribe Version", "4.0-initial-155-gbba175a5", "Asura Version", "(SR 3)"]
...
filterMetaBadWholes = ["P", "b", "cretu", "user", "yeh", "Canon", "times", "is2020", "downes", "American Medical Association"
                      ...
                      , "dan", "decosta", "gottfredson", "van den Hurk", "Word", "pdftk-java 3.0.9", "bar", "tmp", "jvore", "ÿþ", "I.R.I.S.", "C&M", "C&amp;M", "()", "[]", "{}", "Gundars Strads", "Error - CORE file server", "comp2", "u2ps", "mac2", "Chrome", "Chromium", "Firefox", "Safari", "Author", "Binsbench", "Western Publishing"]
...
htmlRewriteFixed =
         ...
         , ("genetically informative", "genetically-informative")
         , ("Genetically Informative", "Genetically-Informative")
         , ("learn-ing", "learning")
