...
redirectDB = let wp u = if "http" `T.isPrefixOf` u then u -- allow overrides of arbitrary URLs (eg. other WMF projects, or for deleted articles, IA)
          ...
          , ("Power_of_a_test", "Power_(statistics)")
          ...
          , ("Ricardo%27s_theorem", "Comparative_advantage#Classical_theory_and_David_Ricardo%27s_formulation")
          , ("Ricardo's_theorem", "Comparative_advantage#Classical_theory_and_David_Ricardo%27s_formulation")
          ...
          , ("Statistical_power", "Power_(statistics)")
          , ("Statistical_power_calculation", "Power_(statistics)")
        ...
        , ("Coalescence", "Coalescent_theory")
        , ("Coalescent", "Coalescent_theory")
