...
redirectDB = let wp u = if "http" `T.isPrefixOf` u then u else T.append "https://en.wikipedia.org/wiki/" u in
          ...
          , ("Lukas_Biewald%2A%2A", "Lukas_Biewald**")
          ...
          , ("One-shot_learning", "Few-shot_learning")
          ...
          , ("Senchas_M%C3%A1r", "Early_Irish_law#Senchas_Már")
          ...
          , ("Tahnoun_bin_Zayed_Al_Nahyan", "Tahnoun_Al_Nahyan")
          , ("Tai_Chi", "Tai_chi")
