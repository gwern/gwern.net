...
import MetadataFormat (linkCanonicalize, guessDateFromString)
import MetadataAuthor (extractTwitterUsername)
...
linkDispatcherURL md l | anyPrefix l ["/metadata/annotation/backlink/", "/metadata/annotation/similar/", "/doc/www/"] = return (Left Permanent)
                 ...
                 | "https://openreview.net/forum?id=" `isPrefixOf` l || "https://openreview.net/pdf?id=" `isPrefixOf` l = openreview md l
