...
linkIDOverrides = map (\o@(_,ident) -> -- NOTE: HTML identifiers *must* start with [a-zA-Z]
      ...
      ("/doc/ai/nn/transformer/gpt/2019-radford.pdf#openai", "gpt-2-paper")
       ...
       , ("/doc/genetics/editing/2020-lu.pdf", "lu-2020-solo-2")
       ...
       , ("/doc/iq/1904-spearman.pdf", "spearman-1904-g")
       ...
       , ("/doc/psychology/neuroscience/2021-xu.pdf", "xu-et-al-2021-rhesus-connectome")
       ...
       , ("/doc/psychology/cognitive-bias/2021-yang.pdf", "yang-et-al-2021-bargraph")
