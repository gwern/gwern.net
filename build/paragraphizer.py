...
# Date: 2022-02-18
# When:  Time-stamp: "2023-04-06 15:29:13 gwern"
# License: CC-0
#
...
messages = [
    ...
    {"role": "user", "content": f"Please process the following abstract (between the '<abstract>' and '</abstract>' tags), by adding double-newlines to split it into paragraphs (one topic per paragraph.) Please also add useful hyperlinks (such as Wikipedia articles) in HTML format to technical terminology or names. Do not duplicate links. Please include ONLY the resulting text with hyperlinks in your output, include ALL the original text, and include NO other conversation or comments.\n\n<abstract>\n{target}\n</abstract>"}
]
