...
titlecase' t = let t' = titlecase $ titlecase'' t
  -- TODO: `titlecase` strips whitespace <https://github.com/peti/titlecase/issues/7> so have to restore it
   ...
   where titlecase'' :: String -> String
         titlecase'' "" = ""
         titlecase'' t' =  replaceMany [("<span Class=\"Logotype-Tex\">", "<span class=\"logotype-tex\">"), ("Cite-author", "cite-author"), ("Cite-date", "cite-date"), ("Cite-joiner", "cite-joiner"), ("Class=","class=")] $ -- HACK
