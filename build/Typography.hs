...
--    cycling pattern, like `<div class="horizontalRule-nth-1"><hr></div>`/`class="horizontalRule-nth-2"`/`class="horizontalRule-nth-3"`/`class="horizontalRule-nth-1"`..., (the div wrapper is necessary because Pandoc's 'HorizontalRule' Block element supports no attributes)
