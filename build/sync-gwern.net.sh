...
# Date: 2016-10-01
# When:  Time-stamp: "2023-08-03 23:12:19 gwern"
# License: CC-0
#
  ...
  if [ "$SLOW" ]; then
    ...
    syntaxHighlight () {
        ...
        for FILE in "$@"; do
            ...
            ) | pandoc --standalone --css=/static/css/colors.css --css=/static/css/initial.css --css=/static/css/default.css --mathjax --write=html5 --from=markdown+smart | \
