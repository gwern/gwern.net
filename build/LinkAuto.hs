...
Date: 2021-06-23
When:  Time-stamp: "2021-08-06 17:43:30 gwern"
License: CC-0
...
custom = sortBy (\a b -> compare (T.length $ fst b) (T.length $ fst a)) [
        ...
        , ("(Edward Luttwak|Luttwak)", "https://en.wikipedia.org/wiki/Edward_Luttwak")
        ...
        , ("[Cc]onfidence interval", "https://en.wikipedia.org/wiki/Confidence_interval")
