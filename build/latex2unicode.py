...
# Date: 2023-06-28
# When:  Time-stamp: "2023-07-06 21:40:13 gwern"
# License: CC-0
#
...
- For superimposed subscript+superscript, use a predefined CSS span class `subsup`, eg. `(\Delta^0_n)` → `Δ<span class="subsup"><sup>0</sup><sub><em>n</em></sub></span>`. This is also useful for summations or integrals, such as `\int_a^b f(x) dx` → `∫<span class="subsup"><sup><em>b</em></sup><sub><em>a</em></sub> <em>f</em>(<em>x</em>) <em>dx</em>`.
