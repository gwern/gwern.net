...
;;; License: CC-0
;;; When:  Time-stamp: "2023-02-15 10:08:08 gwern"
   ...
   (let ((begin (if (region-active-p) (region-beginning) (point-min)))
    ...
    (replace-all "](//doc" "](/doc")
       ...
       (let ((case-fold-search t) (search-upper-case t)) ; need these to override `query-replace` magic‽
         ...
         (query-replace "LaTeX" "<span class=\"latex\">L<span>a</span>T<span>e</span>X</span>" nil begin end)
         (query-replace "TeX" "<span class=\"tex-logotype\">T<sub>e</sub>X</span>" nil begin end))
       ...
       (query-replace-regexp "[Ss]ection ?\\([0-9.]+[a-fA-F]*\\)"  "**Section \\1**" nil begin end) ; Section 9

       (query-replace-regexp "Chapter \\([0-9]+[a-fA-F]*\\)" "**Chapter \\1**"  nil begin end) ; 'Chapter 1', 'Chapter 7a' etc
