ReaderMode = {
    ...
    styles: `
        ...
        /*	Citations.
         */
		body.reader-mode-active.masked-links-hidden .cite-joiner {
			display: initial;
		}
		body.reader-mode-active.masked-links-hidden .cite-author-plural::after {
			content: none;
		}
		body.reader-mode-active.masked-links-hidden .cite-date {
