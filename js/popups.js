...
// Date: 2019-08-21
// When:  Time-stamp: "2019-11-19 15:32:21 gwern"
...
Extracts = {
    ...
    extractForTarget: (target) => {
        let doi = (target.dataset.popupDoi == undefined) ? '' : ` ; <a href="https://ricon.dev/citations_for_doi?doi=${target.dataset.popupDoi}" target='_new' title="Reverse citations of the paper '${target.dataset.popupTitle}' in Semantic Scholar">citations</a>`;
