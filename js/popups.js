...
Extracts = {
	...
	targetElementsSelector: "#markdownBody a.docMetadata, #markdownBody a[href^='./images/'], #markdownBody a[href^='../images/'], #markdownBody a[href^='/images/'], #markdownBody a[href*='youtube.com'], #markdownBody a[href*='youtu.be'], #TOC a, #markdownBody p a[href^='#'], #markdownBody a.footnote-back, span.defnMetadata",
	minPopupWidth: 360,
	maxPopupWidth: 640,
