...
// Date: 2019-08-21
// When:  Time-stamp: "2020-03-09 10:42:31 gwern"
...
Extracts = {
    ...
    targetElementsSelector: "#markdownBody a[href^='http'], #markdownBody a[href^='./'], #markdownBody a[href^='../'], #markdownBody p a[href^='#'], #TOC a",
    minPopupWidth: 360,
    maxPopupWidth: 640,
