...
//
// On mobile (NOTE: temporarily disabled due to size handling problems obscuring the screen/link), clicking on links (as opposed to hovering over links on desktop) will bring up the annotation or preview; another click on it or the popup will then go to it. A click outside it de-activates it.
